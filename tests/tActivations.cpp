...
int main(void)
{
    ...
    run_test("dTanh", ref_dTanh, [](float *x, size_t n)
             { Deep::dTanh(x, n, false); }, data, ITERATIONS);
    run_test("Sigmoid", ref_sigmoid, Deep::sigmoid, data, ITERATIONS);
    run_test("dSigmoid", ref_dSigmoid, [](float *x, size_t n)
             { Deep::dSigmoid(x, n, false); }, data, ITERATIONS);
    run_test("ReLU", ref_relu, Deep::relu, data, ITERATIONS);
    run_test("dReLU", ref_dRelu, [](float *x, size_t n)
             { Deep::dRelu(x, n, false); }, data, ITERATIONS);
