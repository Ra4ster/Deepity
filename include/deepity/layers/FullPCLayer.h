...
namespace Deep
{
    ...
    public:
        ...
        void SetLayerAbove(FullPCLayer *l) noexcept { layerAbove = l; }
        void SetLayerBelow(FullPCLayer *l) noexcept { layerBelow = l; }
        void SetTerminalLayer(FullPCLayer *l) noexcept { terminalLayer = l; }
